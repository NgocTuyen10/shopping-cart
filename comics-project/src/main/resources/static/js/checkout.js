...
$(document)
		.ready(
				function() {
					 ...
					 * formIsValid = true; $('.form-group',
					 * $(this)).each(function() {
					 * 
					 * if (!($(this).hasClass('skip-validate'))) { formIsValid =
					 * formIsValid && $(this).hasClass('has-success'); } }); if
					 * (formIsValid) { $('#submit', $(this)).attr('disabled',
					 * false); } else { $('#submit', $(this)).attr('disabled',
					 * true); } });
					 */
					...
					$('#form')
							.bootstrapValidator(
											...
											ngaySinh : {
												validators : {
													...
													callback : {
														 ...
														 * return false; }
														 * return m
														 * .isAfter(stopWorkTime) &&
														 * m
														 * .isBefore(startWorkTime); }
														 */
													}
												}
											}
								...
								$.ajax({
									url : '/comics/hoa-don-xuat', // url where
									// to submit
									// the
									// request
